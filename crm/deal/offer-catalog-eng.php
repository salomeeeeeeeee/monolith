...
<!-- Pages 2+: one image per PDF page. Each image gets its own .page-content
     ...
     and pages are never created for missing images (which used to cause the
     export to hang forever on an <img src=""> that never fires load/error). -->
...
<script>
    ...
    // causes the PDF export to hang forever on "Loading...".
    if (threeD) {
